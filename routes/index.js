...
exports.freedom = function(req, res) {
	console.log("freedom page requested");
	res.render('timeline.html');
	// res.render('test_2.html');
}

exports.freedomsung = function(req, res) {
	console.log("freedomsung page requested");
	res.render('freedomsung.html');
	// res.render('test_2.html');
}
